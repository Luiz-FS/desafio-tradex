...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product_cost', '0006_remove_productcost_cost__gte_min_cost_and__lte_max_cost_and_more'),
    ]
